...
function drawArtistProfile(Artist $artist): void {?>
    ...
    <body>
        ...
        <section id="profile">
            ...
            <img src="<?= htmlspecialchars($artist->pfp) ?>" alt="profile picture">
            ...
            <div id="UserInfo">
                ...
                <p><strong>Specialty:</strong> <?= htmlspecialchars($artist->category) ?></p>
                <p class="rating"><strong>Rating:</strong> <?= htmlspecialchars((string)$artist->rating) ?></p>
